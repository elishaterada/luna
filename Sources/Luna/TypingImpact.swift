...
final class TypingImpact {
    nonisolated static let strengthKey = "editor.effects.impactStrength"
    nonisolated static let defaultStrength = 1.0
    nonisolated static let strengthRange = 0.25...2.0
    ...
    nonisolated static let animationKey = "luna.typingImpact"
    ...
    nonisolated static let patterns: [Pattern] = [
